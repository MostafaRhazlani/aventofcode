...
const filtredArray = array.filter(arr => arr.every(num => num <= 3 && num != 0 && num >= -3))

const numbersNegativePositive = filtredArray.map(arr => {
    const numbersNegative = arr.every(num => num < 0)
    const numbersPositive = arr.every(num => num > 0)
...
console.log(numbersNegativePositive);
